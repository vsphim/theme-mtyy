...
const language = {
    0:'请登录后查看', 1:'立即登录', 2:'空列表', 3:'分享积分赚钱', 4:'Xem thêm', 5:'Rút ngọn', 6:'您确认购买此条数据访问权限吗？', 7:'暂无角色简介', 8:'角色简介', 9:'角色详情', 10:'封面图',
    11:'相关作品', 12:'明星信息获取失败~', 13:'切换成功~', 14:'请先输入关键词！', 15:'该网站不提供查看', 16:'请输入网址及分享说明（您的分享只有站长可见）：', 17:'提交分享', 18:'分享网址', 19:'验证码', 20:'详情详情',
    21:'音乐地址有时效哦~太长时间后可能无法播放~', 22:'一首巨好听的歌', 23:'分享给你一起听听吧：', 24:'复制内容', 25:'分享音乐', 26:'复制完成，分享给你的好友吧', 27:'错误信息：', 28:'接口请求失败', 29:'没有更多了', 30:'加载更多',
    31:'加载中', 32:'什么都没有', 33:'为本片评分', 34:'复制下方链接，去粘贴给好友吧', 35:'复制链接', 36:'复制完成，分享给你的好友吧', 37:'复制成功~', 38:'复制失败请手动复制下载地址', 39:'明星相关作品获取失败~',
    40:'速度太快了，请稍后在试', 41:'用户登录', 42:'接口加载失败', 43:'已经评分,请务重复评分', 44:'积分提交失败', 45:'暂无播放记录', 46:'暂无搜索记录', 47:'记录已清空', 48:'你还没有输入搜索关键词！', 49:'加载失败，请刷新...',
    50:'请输入您的留言!', 51:'请输入分享内容!', 52:'数据报错', 53:'举报成功~ 感谢您的支持', 54:'取消回复', 55:'请输入您的评论！', 56:'模块mid错误！', 57:'关联id错误', 58:'请求失败，请重试', 59:'看不清楚? 换一张！', 60:'签到成功,积分+',
    61:'收藏成功'
}
var HTML = {
    'Art': function (res, ajaxData) {
        ...
        switch (ajaxData.tpl) {
            ...
            case"actor_type.html":
                for (let i = 0; i < res.list.length; i++) {
                    let pd = res.list[i];
                    let str = '<div class="public-list-box public-pic-b public-pic-wap">' +
                        '<div class="public-list-div">' +
                        '<a'+HTML.Target(res['ajax']['vod_target'])+' class="public-list-exp" href="' + HTML.ArtType(res['rewrite'],pd.actor_id,pd.actor_en, ajaxData['url']) + '" title="">' +
                        '<img alt="' + pd['actor_name'] + '" class="lazy lazy3 gen-movie-img mask-'+res['mask']+'" src="' + HTML.Pic(pd.actor_pic) + '" />' +
                        '<div class="bj-100"></div><div class="actor-name ft4 cor3">' + pd['actor_name'] + '</div></a></div></div>';
                    list.push(str)
                }
                break;
            case"vod":
